...
- Traemos ```SELECT``` y pintamos ```echo``` las [imágenes de los libros](https://github.com/dannylarrea/reread-php/tree/dev/img) mediante una consulta a la base de datos en el fichero **ebooks.php**
